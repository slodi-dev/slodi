...
| **Gamification / leader engagement (cluster L)** | Nice-to-have adoption incentive, not a core need. Usage badges/points/Slóðaverðlaun add maintenance burden for two people with no core-value payoff. | #74, #75, #95 |
