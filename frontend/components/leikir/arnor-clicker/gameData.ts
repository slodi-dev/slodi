...
export const WORKERS: Worker[] = [
  { key: "thingfulltrui",         name: "Þingfulltrúi",          icon: "user",      color: "hsl(150 48% 40%)", fg: INK,            baseCost: 15,                     growth: 1.15, out: 0.1 },
  { key: "kosning",               name: "Kosning",               icon: "hand",      color: "hsl(175 52% 40%)", fg: INK,            baseCost: 100,                    growth: 1.15, out: 1 },
  { key: "kaffipasa",             name: "Kaffipása",             icon: "coffee",    color: "hsl(25 50% 44%)",  fg: INK,            baseCost: 1_100,                  growth: 1.15, out: 8 },
  { key: "umraeduhopar",          name: "Umræðuhópar",           icon: "chat",      color: "hsl(42 68% 48%)",  fg: "currentColor", baseCost: 12_000,                 growth: 1.14, out: 47 },
  { key: "lagabreytingartillaga", name: "Lagabreytingartillaga", icon: "scroll",    color: "hsl(78 45% 43%)",  fg: INK,            baseCost: 130_000,                growth: 1.13, out: 260 },
  { key: "rifrildi",              name: "Rifrildi í pontu",      icon: "mega",      color: "hsl(6 70% 52%)",   fg: INK,            baseCost: 1_400_000,              growth: 1.12, out: 1_400 },
  { key: "ritari",                name: "Ritari",                icon: "pen",       color: "hsl(212 42% 46%)", fg: INK,            baseCost: 20_000_000,             growth: 1.11, out: 7_800 },
  { key: "kjornefnd",             name: "Kjörnefnd",             icon: "clipboard", color: "hsl(192 58% 45%)", fg: INK,            baseCost: 260_000_000,            growth: 1.10, out: 44_000 },
  { key: "fjarmal",               name: "Fjármálaumræður",       icon: "coins",     color: "hsl(46 78% 48%)",  fg: "currentColor", baseCost: 3_300_000_000,          growth: 1.10, out: 260_000 },
  { key: "arsskyrsla",            name: "Ársskýrsla stjórnar",   icon: "file",      color: "hsl(224 50% 50%)", fg: INK,            baseCost: 45_000_000_000,         growth: 1.09, out: 1_600_000 },
  { key: "allsherjar",            name: "Allsherjarnefnd",       icon: "users",     color: "hsl(248 42% 52%)", fg: INK,            baseCost: 600_000_000_000,        growth: 1.09, out: 9_500_000 },
  { key: "uppstillingarnefnd",    name: "Uppstillingarnefnd",    icon: "userCheck", color: "hsl(280 44% 52%)", fg: INK,            baseCost: 8_000_000_000_000,      growth: 1.08, out: 62_000_000 },
  { key: "taeknilegir",           name: "Tæknilegir örðugleikar",icon: "alert",     color: "hsl(354 72% 55%)", fg: INK,            baseCost: 110_000_000_000_000,    growth: 1.08, out: 430_000_000 },
  { key: "onnurmal",              name: "Önnur mál",             icon: "list",      color: "hsl(316 40% 50%)", fg: INK,            baseCost: 1_500_000_000_000_000,  growth: 1.08, out: 2_800_000_000 },
  { key: "utilifsrad",            name: "Útilífsráð",            icon: "tent",      color: "hsl(158 52% 34%)", fg: INK,            baseCost: 21_000_000_000_000_000, growth: 1.07, out: 18_000_000_000 },
  { key: "ungmennarad",           name: "Ungmennaráð",           icon: "flag",      color: "hsl(182 62% 42%)", fg: INK,            baseCost: 3.0e17,                 growth: 1.07, out: 130_000_000_000 },
  { key: "althjodarad",           name: "Alþjóðaráð",            icon: "globe",     color: "hsl(205 66% 48%)", fg: INK,            baseCost: 4.2e18,                 growth: 1.07, out: 900_000_000_000 },
  { key: "starfsrad",             name: "Starfsráð",             icon: "cog",       color: "hsl(232 46% 52%)", fg: INK,            baseCost: 6.0e19,                 growth: 1.07, out: 6.5e12 },
  { key: "skataskolinn",          name: "Skátaskólinn",          icon: "book",      color: "hsl(262 50% 55%)", fg: INK,            baseCost: 8.5e20,                 growth: 1.07, out: 4.8e13 },
  { key: "skataandinn",           name: "Skátaandinn",           icon: "sparkles",  color: "hsl(43 95% 55%)",  fg: "currentColor", baseCost: 1.2e22,                 growth: 1.07, out: 3.8e14 },
];
...
export const UPGRADES: Upgrade[] = [
  { key: "ristabraud", name: "Ristabrauð handa Arnóri", desc: "Tvöfaldar smellikraft Arnórs.", cost: 500, click: 2 },
  { key: "fundarhamar", name: "Nýr fundarhamar",        desc: "Þrefaldar smellikraft.",         cost: 25_000, click: 3 },
  { key: "kaffi",       name: "Kaffi á könnunni",       desc: "+50% á öll fundarsköp.",          cost: 60_000, work: 1.5 },
];
...
export function scoreParts(v: number): ScoreParts {
  ...
  for (const s of SCALES) {
    if (v >= s.min) return { num: isNum(v / s.min), suf: s.suf, name: s.name, pow: `10${superscript(Math.log10(s.min))}` };
  }
