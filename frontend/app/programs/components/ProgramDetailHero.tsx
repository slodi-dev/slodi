    ...
    <div className={styles.hero}>
      ...
      <div className={styles.headerRow}>
        ...
        <div className={styles.actions}>
          {canEdit && !isEditMode && (
            <button onClick={onEdit} className={styles.editButton} aria-label="Breyta dagskrá">
          ...
          >
            <Heart className={styles.icon} size={18} fill={isLiked ? "currentColor" : "none"} />
            <span>{likeCount}</span>
          </button>

          <button onClick={onShare} className={styles.actionButton} aria-label="Deila dagskrá">
