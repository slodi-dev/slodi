    ...
    <div className={styles.container}>
      ...
      <section className={styles.section}>
        ...
        <div className={styles.infoCard}>
          {program.workspace ? (
            <a href={`/workspaces/${program.workspace.id}`} className={styles.link}>
      ...
      <section className={styles.section}>
        ...
        <div className={styles.metadata}>
          <div className={styles.metaRow}>
            ...
            <span className={styles.metaValue}>{formatIcelandicDate(program.created_at)}</span>
          </div>
          <div className={styles.metaRow}>
          ...
          <div className={styles.metaRow}>
            ...
            <span className={styles.metaValue}>{program.comment_count || 0}</span>
          </div>
        </div>
      </section>
